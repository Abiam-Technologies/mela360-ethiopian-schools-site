  ...
  const plans = [
    {
      ...
      features: [
        'MelaStudent+ (Student Management)',
        'MelaAcademics (Grade Management)',
    ...
    },
    {
      ...
      features: [
        ...
        'MelaFinance (Advanced Financial)',
        'MelaHR+ (Staff Management)',
        'MelaCertify (Certificate Generation)',
        'SMS Notifications',
        'Advanced Reports',
    ...
    },
    {
      ...
      features: [
        'Everything in Pro',
        'MelaBus (Transport Management)',
        'MelaConnect (Advanced Parent Communication)',
        'Custom Integrations',
        'Unlimited Students',
        'Priority Support',
        'Custom Reports',
